...
const statementText = {
  ...
  "ar": [
    ...
    "4) نكرم ذكرى القائد الشهيد لإيران آية الله السيد علي خامنئي قدس سره الذي استشهد على يد الولايات المتحدة الأمريكية وإسرائيل وهو يتلو القرآن الكريم.",
    "5) نحترم قرار شعب ونخبة إيران في اختيار آية الله السيد مجتبى خامنئي دام ظله قائداً جديداً لإيران، ونعلن تضامننا معه في دعم المظلومين ومحاربة أمراء الحرب والمتسلطين في العالم."
  ],
  "en": [
  ...
  "pt": [
    "1) Nós, povos livres do mundo, cansados da ganância e do belicismo dos líderes imperialistas, condenamos a agressão ilegítima dos Estados Unidos e de Israel contra o Irã.",
    "2) Condenamos a morte de 168 crianças iranianas indefesas na escola de Minab por um míssil Tomahawk, bem como a morte de outras mulheres e crianças iranianas pelo sindicato Epstein, liderado por Trump e Netanyahu.",
    "3) Permanecemos unidos, com uma só voz, ao lado da grande nação iraniana, apoiando a soberania e a liderança do Irã, que sempre foi amiga dos povos e defensora dos oprimidos.",
    "4) Honramos a memória do líder mártir do Irã, aiatolá Sayyed Ali Khamenei, martirizado pelos Estados Unidos e por Israel enquanto recitava o Sagrado Alcorão.",
    "5) Respeitamos a decisão do povo e das elites do Irã ao escolher o aiatolá Sayyed Mojtaba Khamenei como novo líder do Irã e expressamos nossa solidariedade com ele na defesa dos oprimidos e na luta contra os belicistas e hegemonistas do mundo."
  ],
  "tr": [
...
const i18n = {
  fa: {
    ...
    institutionChipLanguages: "9 زبان فعال", institutionChipSignatures: "امضای زنده و عمومی", heroBadge: "پویش جهانی امضای بیانیه", heroReadBtn: "مطالعه بیانیه", heroSignBtn: "ثبت امضا",
