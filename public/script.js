...
const i18n = {
  fa: {
    dir: "rtl", title: "کمپین با ایران - در سمت درست تاریخ", subtitle: "پویش جهانی حمایت از ملت و رهبری ایران در برابر تجاوزگری امپریالیسم. هر بازدیدکننده می‌تواند نام خود را همراه با یک پیام کوتاه ثبت کند.",
    institutionKicker: "بستر رسمی و چندزبانه", institutionTitle: "سامانه جهانی پویش با ایران - در سمت درست تاریخ", institutionSubtitle: "نمایش زنده شمار امضاها، تفکیک کشوری و پیام‌های کوتاه کاربران در یک قالب رسمی و چندزبانه",
    ...
    feature1Title: "صدای مشترک علیه تجاوز", feature1Text: "بیانیه‌ای برای محکومیت تهاجم ایالات متحده و اسرائیل علیه ایران و دفاع از حقیقت", feature2Title: "همبستگی با رهبری و ملت", feature2Text: "ثبت نام، کشور و پیام کوتاه برای اعلام حمایت از حاکمیت و رهبری جدید ایران", feature3Title: "گزارش زنده آزادگان جهان", feature3Text: "نقشه کشورها، شمار امضاها و بازتاب جهانی پویش در زمان واقعی",
    heroSideKicker: "درباره این کمپین", heroSideTitle: "همراهی با حق، عدالت و کرامت انسانی", heroSideText: "این کمپین برای اعلام همبستگی با ملت ایران و حمایت از رهبری در برابر تجاوزگری و زیاده‌خواهی است. با امضای این متن، صدای خود را در حمایت از مظلومان به گوش افکار عمومی جهان می‌رسانیم.", microPill: "ساده، سریع، چندزبانه", microExample: "نام یا مستعار + کشور + پیام کوتاه", microExampleNote: "برای حفظ کیفیت داده‌ها، پیام‌ها کوتاه نگه داشته می‌شوند و ثبت‌های تکراریِ بسیار سریع محدود می‌گردند.",
